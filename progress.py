...
def all_edit():
    ...
    #motif_fallback = dict()
    #repeat_lengths = []
    out_file = open("output_edit.txt","wt")
    ...
    for repeats in new_motifs:
        ...
        """
        print("=============",file = out_file)
        print(new_motifs[i],file = out_file)
        i=i+1
        print(repeats,file = out_file)
        print("=============",file = out_file)
        ...
        for ext_rep in new_motifs:
            ...
            if(edit_dis == cal_edit_dis):
                print(ext_rep,repeats_out[ext_rep]['class'],cal_edit_dis, file = out_file)
